  ...
  <main class = "bg_color">
    ...
    <div id ="displayArea">
      ...
      <section class = "wd_box">
        <header>
          <h2>Why Become an Agent For Ajax</h2>
        </header>

        <h4>Reason #1 Financial Stability</h4>
        <p>Established in 1955 we bring years of financial stability to the table</p>

        <h4>Reason #2 Agents Payed Weekly</h4>
        <p>Agents receive payments on a weekly basis</h4>

        <h4>Reason #3 Carriers Payed Promtly</h4>
        <p>Carriers are payed 30 days from receipt of all paperwork</p>

        <h4>Reason #4 Free Customer Approval and Credit Checks</h4>
        <p>We do not charge agents for checking the credit of customers</p>

        <h4>Reason #5 Access to 1000's of Carriers</h4>
        <p>We have thousands of carriers in our databse ready to work for you</p>

        <h4>Reason #6 Proprietry Software</h4>
        <p>Our freight managemntsoftware is custom desinged and consistaly updated and improved</p>

        <h4>Reason #7 Fantastic Back Office Suppport</h4>
        <p>User freindly and aways avaialble back office support for problem solving and rate suggestions</p>

        <h4>Reason #8 Unlimited Customers</h4>
        <p>Solicit customers in any area of US</p>

        <h4>Reason #9 Quick Carrier Approval</h4>
        <p>Carries set up is quick and easy for carriers</p>

        <h4>Reason #10 Family Owned and Operated</h4>
        <p>We are a family owned and operated company</p>
        ...
        <section class = "wd_box">
          ...
          <p>Peace of mind knowing you and your carries will be paid. Company security and knowing we plan on being around for years.</p>
        </section>
        ...
        <section class = "wd_box">
          ...
          <p>These simple tools are all you need</p>
          <ol>
            <li>
            ...
            <li>
              A place to work such as your home, a coffee shop, or office
            </li>
          </ol>
        </section>
        ...
        <section class = "wd_box">
          ...
          <p>We are a family owned and operated freight brokerage. We began as an asset based company way back. We later moved into the
          freight brokerage industry. We progressed into a freight agent division.</p>
        </section>
